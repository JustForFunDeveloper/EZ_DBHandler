...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        public SQLQueryBuilder AutoIncrement()
        {
            _query += SQLConstants.AUTO_INCREMENT;
        ...
        public SQLQueryBuilder Show()
        {
            _query += SQLConstants.SHOW;
            return this;
        }
        ...
        public SQLQueryBuilder Triggers()
        {
            _query += SQLConstants.TRIGGERS;
            return this;
        }
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat(SQLConstants.APOSTROPHE_DIAG, value);
            _query += sb.ToString();
            return this;
        }
        ...
        public SQLQueryBuilder TypeTinyInt()
        {
            _query += SQLConstants.TYPE_TINYINT;
            return this;
        }

        public SQLQueryBuilder TypeSmallInt()
        {
            _query += SQLConstants.TYPE_SMALLINT;
            return this;
        }

        public SQLQueryBuilder TypeMediumInt()
        {
            _query += SQLConstants.TYPE_MEDIUMINT;
            return this;
        }

        public SQLQueryBuilder TypeInt()
        {
            _query += SQLConstants.TYPE_INT;
            return this;
        }

        public SQLQueryBuilder TypeBigInt()
        {
            _query += SQLConstants.TYPE_BIGINT;
            return this;
        }

        public SQLQueryBuilder TypeFloat()
        {
            _query += SQLConstants.TYPE_FLOAT;
            return this;
        }

        public SQLQueryBuilder TypeDouble()
        {
            _query += SQLConstants.TYPE_DOUBLE;
            return this;
        }

        public SQLQueryBuilder TypeBoolean()
        {
            _query += SQLConstants.TYPE_BOOLEAN;
            return this;
        }

        public SQLQueryBuilder TypeTime()
        {
            _query += SQLConstants.TYPE_TIME;
            return this;
        }

        public SQLQueryBuilder TypeDateTime()
        {
            _query += SQLConstants.TYPE_DATETIME;
            return this;
        }

        public SQLQueryBuilder TypeTinyText()
        {
            _query += SQLConstants.TYPE_TINYTEXT;
            return this;
        }

        public SQLQueryBuilder TypeMediumText()
        {
            _query += SQLConstants.TYPE_MEDIUMTEXT;
            return this;
        }

        public SQLQueryBuilder TypeLongText()
        {
            _query += SQLConstants.TYPE_LONGTEXT;
            return this;
        }
